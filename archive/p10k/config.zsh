# Generated by Powerlevel10k configuration wizard on 2023-09-23 at 11:37 -03.
...
() {
  ...
  typeset -g POWERLEVEL9K_LEFT_SUBSEGMENT_SEPARATOR='%F{#8087a2}'
  # Separator between same-color segments on the right.
  typeset -g POWERLEVEL9K_RIGHT_SUBSEGMENT_SEPARATOR='%F{#8087a2}'
  ...
  typeset -g POWERLEVEL9K_DIR_SHORTENED_FOREGROUND='#8aadf4'
  # Color of the anchor directory segments. Anchor segments are never shortened. The first
  # segment is always an anchor.
  typeset -g POWERLEVEL9K_DIR_ANCHOR_FOREGROUND='#8aadf4'
  ...
  function my_git_formatter() {
    ...
    if (( $1 )); then
      ...
      local       meta='%F{#363a4f}'  # grey foreground
      ...
      local       meta='%F{#363a4f}'  # grey foreground
      local      clean='%F{#363a4f}'  # grey foreground
      local   modified='%F{#363a4f}'  # grey foreground
      local  untracked='%F{#363a4f}'  # grey foreground
      local conflicted='%F{#363a4f}'  # grey foreground
    fi
  ...
  typeset -g POWERLEVEL9K_BACKGROUND_JOBS_FOREGROUND='#7dc4e4'
  # Custom icon.
  ...
  typeset -g POWERLEVEL9K_ASDF_FOREGROUND='#f5bde6'
  ...
  typeset -g POWERLEVEL9K_ASDF_NODEJS_VISUAL_IDENTIFIER_EXPANSION='nodejs'
  ...
  ####################################[ time: current time ]####################################
  # Current time color.
  typeset -g POWERLEVEL9K_TIME_FOREGROUND='#8087a2'
