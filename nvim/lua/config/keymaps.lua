...
legendary.keymaps({
	...
	{ '<C-j>', '<Cmd>move +1<CR>==', description = 'Move the current line down' },
	{ '<C-k>', '<Cmd>move -2<CR>==', description = 'Move the current line up' },
	{ '<C-j>', ":m '>+1<CR>gv=gv", mode = { 'v' }, description = 'Move selected lines line down' },
	{ '<C-k>', ":m '<-2<CR>gv=gv", mode = { 'v' }, description = 'Move selected lines line up' },
