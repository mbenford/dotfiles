...
require('legendary').bind_keymaps({
	...
	{ '<leader>cc', '<esc><cmd>lua require"Comment.api".toggle_linewise_op(vim.fn.visualmode())<cr>', mode = { 'v' } },
	{ '<leader>cb', '<esc><cmd>lua require"Comment.api".toggle_blockwise_op(vim.fn.visualmode())<cr>', mode = { 'v' } },
